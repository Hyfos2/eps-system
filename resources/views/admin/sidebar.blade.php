...
<nav>
						...
						<ul class="main-navigation-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									<li>
										<a href="{{url('doctor-specialisation')}}">
											<span class="title"> Doctor Specialization </span>
										</a>
									</li>
									<li>
										<a href="{{url('new-doctors')}}">
				...
				<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Pharmacists </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="{{url('add-pharmacist')}}">
											<span class="title"> Add Pharmacist </span>
										</a>
									</li>
									<li>
										<a href="{{url('manage-pharmacist')}}">
...
<li>
	...
	<li>
							...
							<li>
								<a href="{{url('patient-logs')}}">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
										<div class="item-inner">
											<span class="title">Patients Session Logs </span>
										</div>
									</div>
								</a>
							</li>						
				...
				<li>
								<a href="{{url('pharmacist-logs')}}">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
										<div class="item-inner">
											<span class="title">Pharmacists Session Logs </span>
										</div>
									</div>
								</a>
							</li>	
